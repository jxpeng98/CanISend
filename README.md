...
<p align="center">
  ...
  <a href="https://test.pypi.org/project/canisend/"><img src="https://img.shields.io/badge/TestPyPI-0.3.0.dev1-blue" alt="TestPyPI"></a>
...
For the current TestPyPI build, install `canisend==0.3.0.dev1` while still resolving dependencies from PyPI:
