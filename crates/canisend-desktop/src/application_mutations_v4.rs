...
use canisend_app::{
    ...
    ApplicationFlowExportReadModelV3, ApplicationFlowExportRequestV3,
    ApplicationFlowReviewReadModelV3, ApplicationMutationApprovalBrokerV4,
    ApplicationMutationApprovalErrorV4, ApplicationMutationApprovalPreviewV4,
    ...
    PrivateExportConsent, PrivateReadConsent, StoredApplicationModelV3,
};
...
#[derive(Debug, Clone, PartialEq, Eq, Deserialize)]
#[serde(deny_unknown_fields)]
pub(crate) struct ReviewDispositionPreviewDesktopRequestV4 {
    workspace: PathBuf,
    application_id: ApplicationId,
...
#[derive(Debug, Clone, PartialEq, Eq, Deserialize)]
#[serde(deny_unknown_fields)]
pub(crate) struct ReviewDispositionCommitDesktopRequestV4 {
    workspace: PathBuf,
    application_id: ApplicationId,
    preview_token: String,
    preview_sha256: Sha256Digest,
...
#[derive(Debug, Clone, PartialEq, Eq, Deserialize)]
#[serde(deny_unknown_fields)]
pub(crate) struct ExportPreparePreviewDesktopRequestV4 {
    workspace: PathBuf,
    application_id: ApplicationId,
...
#[derive(Debug, Clone, PartialEq, Eq, Deserialize)]
#[serde(deny_unknown_fields)]
pub(crate) struct ExportPrepareCommitDesktopRequestV4 {
    workspace: PathBuf,
    application_id: ApplicationId,
    preview_token: String,
    preview_sha256: Sha256Digest,
...
#[tauri::command]
pub(crate) async fn review_inspect(
    request: DeliverableAuditDesktopRequestV4,
) -> Result<ActionReceipt<ApplicationFlowReviewReadModelV3>, DesktopCommandError> {
    run_worker(move || {
        Application::inspect_review_v4(
            &request.workspace,
            &request.application_id,
            request
                .confirmed_private_read
...
#[tauri::command]
pub(crate) async fn review_disposition_preview(
    state: tauri::State<'_, ApplicationMutationApprovalBrokerV4>,
    request: ReviewDispositionPreviewDesktopRequestV4,
) -> Result<
...
#[tauri::command]
pub(crate) async fn review_disposition_commit(
    state: tauri::State<'_, ApplicationMutationApprovalBrokerV4>,
    request: ReviewDispositionCommitDesktopRequestV4,
) -> Result<ActionReceipt<StoredApplicationModelV3>, DesktopCommandError> {
    let broker = state.inner().clone();
    run_worker(move || {
        broker
...
#[tauri::command]
pub(crate) async fn export_prepare_preview(
    state: tauri::State<'_, ApplicationMutationApprovalBrokerV4>,
    request: ExportPreparePreviewDesktopRequestV4,
) -> Result<ApplicationMutationApprovalPreviewV4<ApplicationFlowExportRequestV3>, DesktopCommandError>
{
    let broker = state.inner().clone();
    run_worker(move || {
        broker
...
#[tauri::command]
pub(crate) async fn export_prepare_commit(
    state: tauri::State<'_, ApplicationMutationApprovalBrokerV4>,
    request: ExportPrepareCommitDesktopRequestV4,
