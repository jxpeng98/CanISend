...
mod tests {
    ...
    use canisend_contracts::{
        ExecutionMode, PlannedDeliverableDispositionV3, RequirementPriorityV3, WorkflowPackItemId,
    };
    ...
    #[test]
    fn generic_desktop_commands_preserve_full_semantic_lifecycle_and_failures() {
