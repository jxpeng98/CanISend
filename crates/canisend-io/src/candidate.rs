...
pub fn read_task_completion_file(path: &Path) -> Result<TaskCompletionRequest, IoAdapterError> {
    ...
    if metadata.len() > MAX_TASK_COMPLETION_BYTES {
...
mod tests {
    ...
    use super::{MAX_TASK_COMPLETION_BYTES, read_task_completion_file, read_task_completion_stdin};
