...
local export. GF4-EXAMPLE-001 also runs four fully synthetic domain families through this exact
Pack offline. Agent v2 and the `job` CLI remain academic-only compatibility surfaces and must fail
