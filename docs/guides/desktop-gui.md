...
The clean-v4 public CLI has 23 exact leaves. Its MCP adapter currently exposes eleven operations:
nine body-free read/preview operations and two single-use guarded association commits. Source-level
