...
qualified checkpoint is `v1.0.0-alpha.5`. Verify the exact release manifest because post-tag source
is not a published update. Intel macOS users can use the standalone CLI archive during Alpha.
