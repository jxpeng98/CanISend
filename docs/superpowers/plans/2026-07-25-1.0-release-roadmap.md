...
[Workspace v4 storage](../../contracts/workspace-v4-storage.md). GitHub evidence and task state
remain authoritative until the verified PR and remote matrix are recorded.
