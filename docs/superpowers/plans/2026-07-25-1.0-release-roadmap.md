...
become Verified. The global context bar still projects the retired Job selection and must be
rebound to the active v4 Application collection in a follow-up before the Slice C exit is claimed.
