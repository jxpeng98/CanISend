...
| M1F-SURFACE-001 | [Workflow Pack presentation contract](../../contracts/workflow-pack-presentation-v1.md), [GF3 desktop implementation record](../../notes/rust-native/2026-08-03-gf3-pack-backed-ui.md), [GF4 generic CLI/desktop record](../../notes/rust-native/2026-08-03-gf4-generic-cli-desktop.md), and [Agent v3/MCP contract](../../contracts/agent-v3-mcp.md) | App facade, CLI, Tauri, Agent v3/MCP, and desktop expose exact Pack selection plus generic create/resume/plan/compose/review/approve/export with English/Chinese Pack labels and no fixed academic Deliverable branch; canonical operation-registry parity, direct v3 source adapters, native qualification, and work-item linkage remain before this item can be marked Verified |
...
Current source evidence for M1-OP-001/002 is the
...
states. M1-OP-003 semantic outcome qualification remains open, so the M1A exit gate is not yet
complete.
...
stores, predictable adapter tokens, or missing expiry contracts from returning. M1-OP-003 and the
remaining M1A gates remain open.
