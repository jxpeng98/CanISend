...
| M1F-SURFACE-001 | [Workflow Pack presentation contract](../../contracts/workflow-pack-presentation-v1.md) and [GF3 desktop implementation record](../../notes/rust-native/2026-08-03-gf3-pack-backed-ui.md) | App-facade and desktop Pack presentation are implemented with English/Chinese fallback and no fixed four-Deliverable UI branch; CLI/MCP canonical v3 surface parity, generic field submission, native qualification, and work-item linkage remain before this item can be marked Verified |
