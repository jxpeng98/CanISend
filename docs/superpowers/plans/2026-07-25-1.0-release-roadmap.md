...
**Next intended checkpoint:** `v1.0.0-beta.2` remains the active private source checkpoint under
the same feature freeze. Its nonpublishing native candidate is independently verified at protected
...
`acf25dc483643ca9be0210320775708da116b715`. No Beta.2 tag, release, package, or qualification is
authorized here. The consented body-free cohort is the next required checkpoint before RC.1
planning.
