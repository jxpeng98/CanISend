...
| The full desktop mixed-Pack lifecycle is retained on an exact local ad-hoc package, while the clean-tag package remains unqualified | P0 before Alpha.7 | The retained interaction closes the source gap but cannot qualify the public App bytes |
