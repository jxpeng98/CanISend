...
never the private body. The compiled inventory is now 28 CLI, 111 Tauri, and 16 MCP leaves, with
18 shared operations qualified by the two-Pack semantic matrix. `deliverable.audit` and all
Requirement/Plan/Deliverable mutations remain separate follow-up work because they require explicit
private-read or preview/approval boundaries.
