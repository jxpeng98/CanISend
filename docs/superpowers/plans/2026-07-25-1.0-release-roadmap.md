...
|---|---|---|
| Post-Alpha.5 source remains versioned as Alpha.5 and has no exact Alpha.6 candidate | P0 | Published Alpha.5 evidence does not qualify changed bytes; only the separately authorized M2 sequence may advance it |
| M0 feedback-path and active workflow-default tasks remain open | P0 | Historical post-0.7 and Beta/RC defaults cannot become active 1.0 release authority |
| M1F source exists but exact packaged migration and academic-v3 parity evidence remains incomplete | P0 before Alpha.6 | Strong source fixtures cannot replace retained old/new binary, package, and native recovery qualification |
| The generic Pack was implemented early but has no exact public Alpha.7 qualification | P0 before Beta | Framework genericity must be proven from public dual-Pack bytes, not inferred from unqualified source |
...
| The reviewed `canisend-store -> canisend-io` exception expires on 2026-08-17 | P1 before freeze | It must be removed or explicitly renewed with the named failure evidence before its authority expires |

Repository-governance setup is now complete: seven Roadmap milestones and one Issue per P0/P1 ID
...
| M0-STATE-002 / STATE-003 | [M0 release-truth closure](../../notes/rust-native/2026-08-03-m0-release-truth-closure.md), active-surface fixtures, and snapshot-declared feedback path | Issues #8 and #9 are In progress on `agent/alpha6-m0-closure`; local focused and release-source checks pass, protected integration pending |
| M0-REL-002 / REL-003 | [M0 release-truth closure](../../notes/rust-native/2026-08-03-m0-release-truth-closure.md), Alpha.7 authority and sequential-RC fixtures, and post-freeze runbook | Issues #11 and #12 are In progress on `agent/alpha6-m0-closure`; local focused and release-source checks pass, protected integration pending |
| M0-WF-001 / FEEDBACK-001 / DOC-001 | [M0 release-truth closure](../../notes/rust-native/2026-08-03-m0-release-truth-closure.md), dynamic workflow checks, latest-RC fixture, and reconciled active docs | Issues #13–#15 are In progress on `agent/alpha6-m0-closure`; local focused and release-source checks pass, protected integration pending |
