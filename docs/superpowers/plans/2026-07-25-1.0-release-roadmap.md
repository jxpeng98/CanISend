...
archives. Feature-freeze activation and invited-user evidence remain pending. No external package
index is modified, no RC is recorded, and Stable is not authorized.
...
**Next intended checkpoint:** `v1.0.0-beta.1` feature-freeze preparation and activation. The
published Beta artifact source remains `6e1397b79031cad54e794ccdc9edca2153f23b3e`; the separate
repository baseline will be the exact protected preparation merge `HEAD`. The invited cohort
remains required before RC. Beta.1 is qualified and has local package-channel candidates but is
not yet frozen.
...
metadata and this protected reconciliation; `M4-FREEZE-002` / Issue #77 is next.
`M3-EVID-005` / Issue #70 runs after public Beta.1 and before RC.1. When sources disagree,
correct the lower-authority projection before advancing the affected gate; historical Alpha
...
- [ ] Feature-freeze baseline equals the exact protected post-qualification repository `HEAD`, and
...
17. **Next:** activate feature freeze, then complete `M3-EVID-005` / Issue #70 before RC.1.
18. Qualify two distinct RCs, complete every Stable evidence class, and publish Stable only after
