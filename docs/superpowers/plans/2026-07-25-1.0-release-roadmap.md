...
**Next intended checkpoint:** `v1.0.0-beta.3` is the active source version for the owner-directed
local npm testing prerelease. Publish the locally verified CLI through npm's `next` channel;
