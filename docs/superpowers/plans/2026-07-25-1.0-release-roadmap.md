...
**Status:** Active — authoritative; M1 framework-foundation verification is the current milestone
...
The [M1F workflow-pack framework verification candidate](../../notes/rust-native/2026-08-03-m1f-framework-verification.md)
...
critical browser tests pass. The table below remains non-Verified until the exact candidate merges
through protected `main`, required remote CI is inspected, and Issues #19–#29 carry the merge and
run evidence.
