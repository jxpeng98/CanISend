...
| M0-SCOPE-002 | [Generic framework coupling audit](../../notes/rust-native/2026-08-02-generic-framework-coupling-audit.md), [checked inventory contract](../../contracts/domain-coupling-inventory-v1.json), and `xtask scope inventory/check` | Issue #4 is In progress on Draft PR #95; 188 files have generated ownership and eight required areas are source-gated, pending protected integration evidence before Verified |
