...
| Task | Repository evidence | Remaining state boundary |
|---|---|---|
| M1F-MIG-001 | [Workspace v2→v3 contract](../../contracts/workspace-v2-to-v3-migration.md) and [migration implementation record](../../notes/rust-native/2026-08-02-gf2-workspace-v3-migration.md) | Consume the reviewed built-in academic Pack and inspect the committed source gate before marking Verified |
