...
`M3-ALPHA9-001` is In progress after explicit entry authorization on 2026-08-12; its write, merge,
candidate, tag, promotion, publication, and host actions remain separately authorized.
`M3-EVID-005` / Issue #70 waits for real invited users and the exact qualified Alpha.9. Create
...
9. **In progress 2026-08-12:** entry for `M3-ALPHA9-001` was explicitly authorized. Qualify the
   next sequential Alpha from the exact protected source before affected cohort evidence resumes;
   each release transition remains separately authorized.
