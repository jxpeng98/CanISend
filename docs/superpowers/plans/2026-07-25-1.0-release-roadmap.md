...
| Task | Repository evidence | Remaining state boundary |
|---|---|---|
| M1F-PACK-001 | [Workflow Pack v1 contract](../../contracts/workflow-pack-v1.md), [generic starter Pack contract](../../contracts/generic-application-workflow-pack-v1.md), and [GF4 implementation record](../../notes/rust-native/2026-08-03-gf4-generic-starter-pack.md) | Two built-in Packs now pass the same exact resource/digest/runtime/capability registry with disjoint stage and Deliverable catalogs; external installation, full CLI/MCP/desktop surfaces, native qualification, and work-item linkage remain before this item can be marked Verified |
...
| M1F-SURFACE-001 | [Workflow Pack presentation contract](../../contracts/workflow-pack-presentation-v1.md), [GF3 desktop implementation record](../../notes/rust-native/2026-08-03-gf3-pack-backed-ui.md), and [GF4 generic CLI/desktop record](../../notes/rust-native/2026-08-03-gf4-generic-cli-desktop.md) | App facade, CLI, Tauri, and desktop now expose exact Pack selection plus generic create/resume/plan/compose/review/approve/export with English/Chinese Pack labels and no fixed academic Deliverable branch; MCP canonical v3 parity, direct v3 source adapters, native qualification, and work-item linkage remain before this item can be marked Verified |
