...
**Status:** Active — authoritative; Alpha.10 is published with an open host-qualification gap and
Beta.1 readiness is pending
...
`cd40180f2ff8ac957276f1948ba88da428511a82`; candidate and public bytes agree, but its accepted
provider-host qualification remains incomplete because Claude Code was skipped by the maintainer.

**Current public checkpoint:** [`v1.0.0-alpha.9`](https://github.com/jxpeng98/CanISend/releases/tag/v1.0.0-alpha.9)
at `4876c5669b7ae48ca053b5e06e0005419d2051f6`, published 2026-08-12. It remains the latest fully
provider-qualified checkpoint and the current Issue #70 cohort baseline.

**Latest published prerelease:** [`v1.0.0-alpha.10`](https://github.com/jxpeng98/CanISend/releases/tag/v1.0.0-alpha.10)
at `cd40180f2ff8ac957276f1948ba88da428511a82`, published 2026-08-29. Its same-byte promotion and
public assets are verified; M3-ALPHA10-001 remains In progress until its explicit host gap is
resolved or its acceptance boundary is separately revised.
...
contract only after the open provider-host gap and post-release target-user/readiness gates pass.
Beta is not yet authorized.
...
PR #196 and archived. `M3-ALPHA10-001` / Issue #194 is the next planned qualification child.
`M3-EVID-005` / Issue #70 remains the real-user evidence gate and may be rebound only after exact
public Alpha.10 exists. Create
...
Alpha.10 publication evidence: [public release](https://github.com/jxpeng98/CanISend/releases/tag/v1.0.0-alpha.10),
...
and the [body-free qualification-gap note](../../notes/rust-native/2026-08-29-alpha10-public-qualification-gap.md).
Codex CLI, Claude Desktop, and the bounded MCP client passed without mutation or submission;
Claude Code is `skipped-by-maintainer`. M3-ALPHA10-001, Issues #194/#68, and milestone 10 remain
open, while `release/provider-dogfood.json` and Issue #70 remain bound to fully qualified Alpha.9.
...
- [ ] Exact public Alpha.10 binds the protected headless capability and same-byte public artifacts;
  Claude Code host qualification remains `skipped-by-maintainer`.
...
- [ ] Exact public Alpha.10 is fully provider-qualified and becomes the invited-cohort baseline;
  same-byte publication is complete, but Claude Code host evidence is still open.
