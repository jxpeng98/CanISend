...
independently verified. Alpha.10 remains the immutable Codex-qualified entry checkpoint.
...
**Next intended checkpoint:** record Beta qualification from the independently downloaded public
Beta.1 assets, generate local package-channel candidates, and activate feature freeze against the
qualified source. The invited cohort then runs on public Beta.1 and remains required before RC.
Beta.1 is public but not yet qualified or frozen.
