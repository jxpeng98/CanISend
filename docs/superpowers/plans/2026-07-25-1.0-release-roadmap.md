...
| LF-C10 | LF-C05 | Qualify exact standalone CLI baseline, clean-machine lifecycle and business flow; tested cohort-binding transition if required | Planned; release separately authorized |
