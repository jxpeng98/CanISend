...
**Next intended checkpoint:** `v1.0.0-beta.1` feature-freeze activation against qualified source
`6e1397b79031cad54e794ccdc9edca2153f23b3e`. The invited cohort remains required before RC.
Beta.1 is qualified and has local package-channel candidates but is not yet frozen.
