...
**Next intended checkpoint:** `v1.0.0-beta.10` is the active source version. Its owner-directed
npm, Cargo and PyPI testing prerelease was published and independently verified through
`release.yml` run `35704356744`, from `ed0ce00a82c5190e4764f636f5a0d65c71f22976`.
The npm package and PyPI wheels cover macOS ARM64 and Linux GNU x86_64/arm64. The
[release record](../../../RELEASE.md) retains exact checksums and verification.
