...
| Task | Evidence | Remaining state boundary |
|---|---|---|
| GF3-PACK-001 | [Academic reference Pack contract](../../contracts/academic-job-workflow-pack-v1.md), [implementation record](../../notes/rust-native/2026-08-02-gf3-academic-reference-pack.md), and [workflow-pack v1 contract](../../contracts/workflow-pack-v1.md) | Declarative bundle, canonical parity, built-in migration consumption, and adapter binding are implemented; complete GF3-COMPAT/UI, create/link its work item, and inspect committed source evidence before marking Verified |
| GF3-ADAPTER-001 | [Opportunity-source adapter contract](../../contracts/opportunity-source-adapters-v1.md), [implementation record](../../notes/rust-native/2026-08-03-gf3-opportunity-source-adapters.md), and [academic Pack contract](../../contracts/academic-job-workflow-pack-v1.md) | Pack-qualified catalog and preview/commit admission are implemented with destination, limit, provenance, refresh, and promotion regressions; add canonical v3 surface routing, create/link its work item, and inspect committed source/native evidence before marking Verified |
| GF3-COMPAT-001 | [Academic v2 compatibility contract](../../contracts/academic-v2-compatibility-v1.md), [implementation record](../../notes/rust-native/2026-08-03-gf3-agent-v2-compatibility.md), and [academic Pack contract](../../contracts/academic-job-workflow-pack-v1.md) | Exact academic admission, explicit v3 mapping, migrated read-only behavior, generic failure closure, CLI golden fixtures, and MCP parity are implemented; create/link its work item and inspect committed source/native evidence before marking Verified |
| GF3-UI-001 | [Workflow Pack presentation contract](../../contracts/workflow-pack-presentation-v1.md), [implementation record](../../notes/rust-native/2026-08-03-gf3-pack-backed-ui.md), and [academic Pack contract](../../contracts/academic-job-workflow-pack-v1.md) | Verified Pack vocabulary, fields, bilingual stage labels, Deliverable labels, and exact legacy draft choices drive the principal desktop journey without a fixed four-kind UI branch; generic Pack selection and v3 field submission remain GF4, and governance work-item linkage remains required before marking Verified |
...
| Task | Evidence | Remaining state boundary |
|---|---|---|
| GF4-PACK-001 | [Generic starter Pack contract](../../contracts/generic-application-workflow-pack-v1.md), [implementation record](../../notes/rust-native/2026-08-03-gf4-generic-starter-pack.md), [synthetic examples record](../../notes/rust-native/2026-08-03-gf4-synthetic-examples.md), and [Workflow Pack v1 contract](../../contracts/workflow-pack-v1.md) | Embedded Pack, exact digest/resource verification, neutral metadata/taxonomies, compiled nine-stage graph, two custom Deliverables, bilingual localization, exact dual-Pack registry resolution, Agent v3 binding, and four offline domain families are implemented; create/link its work item and inspect committed source evidence before marking Verified |
| GF4-FLOW-001 | [Canonical Application flow v3 contract](../../contracts/application-flow-v3.md), [implementation record](../../notes/rust-native/2026-08-03-gf4-canonical-generic-flow.md), [Agent v3/MCP contract](../../contracts/agent-v3-mcp.md), [synthetic examples record](../../notes/rust-native/2026-08-03-gf4-synthetic-examples.md), [Application model v3](../../contracts/application-model-v3.md), and [Application projections v3](../../contracts/application-projections-v3.md) | New/empty v3 activation, Pack-qualified intake/Requirement/Plan/Deliverable operations, explicit approval, managed package projection, neutral embedded rendering, consented local export, Agent v3 guarded operations, four two-Deliverable offline families, and stale/wrong-Pack/no-mutation regressions are implemented; create/link its work item and inspect committed source/native evidence before marking Verified |
| GF4-UI-001 | [Generic CLI/desktop implementation record](../../notes/rust-native/2026-08-03-gf4-generic-cli-desktop.md), [canonical flow contract](../../contracts/application-flow-v3.md), [Agent v3/MCP contract](../../contracts/agent-v3-mcp.md), and [Workspace migration contract](../../contracts/workspace-v2-to-v3-migration.md) | Exact Pack creation, CLI, desktop, and Agent/MCP create/resume/plan/compose/review/approve/export, bilingual Pack-derived forms, UTF-8 span checks, accessibility contracts, and preview/digest/backup-bound migration are implemented; direct v3 file/PDF/URL adaptation, native qualification, work-item linkage, and independent evidence inspection remain before marking Verified |
| GF4-AGENT-001 | [Agent v3/MCP contract](../../contracts/agent-v3-mcp.md), [implementation record](../../notes/rust-native/2026-08-03-gf4-agent-v3-mcp.md), and [academic v2 compatibility contract](../../contracts/academic-v2-compatibility-v1.md) | Body-free exact-Pack context, nine canonical MCP operations, HostAgent/user actor routing, Codex/Claude handoffs, explicit decisions and consent, snapshot-bound single-use approval, stale/replay/wrong-Pack failure, refreshed-review recovery, and GF5 minimum semantic parity are implemented; native qualification, work-item linkage, and independent committed-evidence inspection remain before marking Verified |
| GF4-EXAMPLE-001 | [Example fixture contract](../../contracts/generic-application-example-v1.md), [implementation record](../../notes/rust-native/2026-08-03-gf4-synthetic-examples.md), and [offline test guide](../../testing/generic-application-examples.md) | Grant, admission, tender/proposal, and professional job examples are embedded, SHA-256 verified, explicitly fictional, free of external locators/contact identifiers, and complete the real two-Deliverable flow through validated PDF export without submission; native qualification, work-item linkage, and independent committed-evidence inspection remain before marking Verified |

Completion of the GF4 source scope does not itself qualify an Alpha. The
[first usable Alpha gap audit](../../notes/rust-native/2026-08-03-first-usable-alpha-gap-audit.md)
records the still-unproven M1A/GF5 P0 gates and the ordered path to exact native qualification.
...
release source gate. GF5-PARITY-001 source implementation is recorded in the
